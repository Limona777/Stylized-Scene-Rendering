Shader "Sand/RenderTerrain_Tess" {
    Properties{
    ...
    SubShader{
        Tags{ "RenderType" = "Opaque" "DisableBatching" = "True" "SandFloor" = "True" }
        LOD 200
        ...
        Pass{
            ...
            FragInput domain(HullConstantOutput constantData, const OutputPatch<DomainInput, 3> i, float3 bary : SV_DomainLocation)
            {
                ...
                position += normalize(float3(0, 1, 0)) * saturate(1 - displace) * (_SandMaxHeight);
                ...
                fixed3 worldNormal = normalize(worldN);
        ...
        Pass{
            ...
            FragInput domain(HullConstantOutput constantData, const OutputPatch<DomainInput, 3> i, float3 bary : SV_DomainLocation)
            {
                ...
                position += normalize(float3(0,1,0)) * saturate(1 - displace.x) * _SandMaxHeight;
